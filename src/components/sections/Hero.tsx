  ...
  return (
    <section id="hero" className="relative overflow-hidden bg-ink">
      ...
      <div className="site-shell relative flex min-h-[52vh] flex-col justify-end pb-4 pt-24 sm:min-h-[68vh] sm:pb-6 sm:pt-32">
        ...
        <FadeIn delay={60}>
          <h1 className="mt-3 max-w-3xl text-balance text-[1.75rem] font-semibold leading-[1.08] tracking-tight text-white sm:mt-4 sm:text-5xl lg:text-[3.25rem]">
            Фестивали и конкурсы искусств и творчества
          </h1>
        </FadeIn>
